...
from dvrtc_attack_common import DEFAULT_SQLI_PAYLOAD_TEMPLATE, run_sqli_check


def cmd_sqli(args: argparse.Namespace) -> int:
    return run_sqli_check(
        args.host,
        args.extension,
        args.timeout,
        token=args.token,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Check SIP->SQL injection path")
    ...
    parser.add_argument(
        "--payload-template",
        default=DEFAULT_SQLI_PAYLOAD_TEMPLATE,
